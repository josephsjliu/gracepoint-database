...
if($name == "" || $add == "") {
  header("Location: addinglocation.php");
}
...
// Now insert data.
$insert = "INSERT INTO Gracepoint.t_location (Name, Address_Info) VALUES ('{$_POST['Name']}', '{$_POST['Address_Info']}')";
